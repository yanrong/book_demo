/****************************************************************************
** Meta object code from reading C++ file 'datetimedelegate.hpp'
**
** Created: Fri Apr 11 18:10:05 2014
...
#error "The header file 'datetimedelegate.hpp' doesn't include <QObject>."
...
const QMetaObjectExtraData DateTimeDelegate::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject DateTimeDelegate::staticMetaObject = {
    { &QStyledItemDelegate::staticMetaObject, qt_meta_stringdata_DateTimeDelegate,
      qt_meta_data_DateTimeDelegate, &staticMetaObjectExtraData }
};

...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Newspaper_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 21, 4)
    ...
    "Newspaper\0newsPaper\0\0name\0"
};
...
void Newspaper::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Newspaper::newsPaper)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Newspaper::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Newspaper.data,
      qt_meta_data_Newspaper,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Newspaper.stringdata))

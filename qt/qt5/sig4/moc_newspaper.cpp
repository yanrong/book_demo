...
static const char qt_meta_stringdata_Newspaper[] = {
    "Newspaper\0\0name\0newsPaper(QString)\0"
};
...
void Newspaper::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->newsPaper((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData Newspaper::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Newspaper::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Newspaper,
      qt_meta_data_Newspaper, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Newspaper::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Newspaper))
...
// SIGNAL 0
void Newspaper::newsPaper(const QString & _t1)
{

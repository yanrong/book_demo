...
public:
    ...
    {
        ResizeDialog->setWindowTitle(QApplication::translate("ResizeDialog", "Image Pro", Q_NULLPTR));
        mainLabel->setText(QApplication::translate("ResizeDialog", "Enter new size:", Q_NULLPTR));
        xLabel->setText(QApplication::translate("ResizeDialog", "x", Q_NULLPTR));
        okButton->setText(QApplication::translate("ResizeDialog", "OK", Q_NULLPTR));
        cancelButton->setText(QApplication::translate("ResizeDialog", "Cancel", Q_NULLPTR));
    } // retranslateUi

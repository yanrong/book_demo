...
**
** Created: Sat Dec 7 22:16:40 2013
...
static const char qt_meta_stringdata_Layout[] = {
    "Layout\0"
};
...
const QMetaObjectExtraData Layout::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Layout::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_Layout,
      qt_meta_data_Layout, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Layout::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Layout))

...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ButtonWindow_t, stringdata) + ofs \
...
const QMetaObject ButtonWindow::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_ButtonWindow.data,
      qt_meta_data_ButtonWindow,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ButtonWindow.stringdata))
